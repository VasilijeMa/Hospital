...
using ZdravoCorp.Core.PatientHealthcare.Hospitalcare.Repositories;
using ZdravoCorp.Core.PatientHealthcare.Hospitalcare.Repositories.Interfaces;
using ZdravoCorp.Core.PatientHealthcare.PatientMedicalRecord.Repositories;
    ...
    public class Institution
    {
        ...
        public static Institution Instance
        {
            get
            {
                if (instance == null)
                {
                    return instance = new Institution();
                }
                return instance;
            }
        }
